...
# Enter your search terms inside '[ ]' with quotes ' "searching title" ' for each search followed by comma ', ' Eg: ["Software Engineer", "Software Developer"]
search_terms = ["Full Stack Developer", "React Developer Engineer", "Front End Developer", "Web Developer", "Nodejs Developer"]

# Search location, this will be filled in "Benglore, Karnataka, or 560030" search box. If left empty as "", tool will not fill it.
search_location = "Los Angeles, California, Bengaluru, Bangalore, India" # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
...
about_company_good_words = ["dynamic multiple search"]      # (dynamic multiple search) or leave empty as []. Ex: ["Robert Half", "Dice"]
